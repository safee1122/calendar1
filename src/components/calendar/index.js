...
import "./calendar.css";
import clock from "./Ellipse 54.png"
  ...
  render() {
    ...
    return (
      <div className="tail-datetime-calendar">
        ...
        <span style={{ padding: '0px' }} className="calendar-date">
        ...
        <div className="imgContainer">
          <div className="timeIcon">
            <span >
              <p>8:30am</p>
              <img className="clockIcon" src={clock}></img>
              <img className="innerIcon" src={inner}></img>
            </span>
          </div>
